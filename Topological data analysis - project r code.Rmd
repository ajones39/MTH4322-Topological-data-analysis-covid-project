...
Showing different ball mapper plots for different epsilon values, showing 0.4 is the nicest value:


```{r}
eps_examples <- c(0.3, 0.4, 0.5, 0.6)
...
data_ball <- data_clean %>%
  left_join(
    ...
    by = "country",
     relationship = "many-to-many" #To silence thee warning about many-to-many by r
  )
